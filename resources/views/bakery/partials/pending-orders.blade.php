    ...
    <div class="max-w-7xl mx-16 sm:px-6 lg:px-8">
        <nav class="text-sm" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
                ...
                <li class="flex items-center">
                    <a href="/bakery/orders/pending" class="text-gray-700 hover:text-gray-900"> &nbsp&nbsp Pending Orders</a>
                </li>
            </ol>
        </nav>
    </div>
...
<div class="space-x-8 sm:-my-px sm:ms-10 mt-5 mb-4 hidden lg:flex sm:items-center">
    @if (Auth::user()->usertype == 'bakery')
        <x-nav-link href="{{ route('bakery.orders.pending') }}" 
        :active="request()->routeIs('bakery.orders.pending')" 
        class="text-orange-500 hover:text-orange-300 active:text-amber-400 border-b-4 border-orange-500 hover:border-b-4 hover:border-amber-400 active:border-b-4 active:border-red-500 pb-3 text-xl">
