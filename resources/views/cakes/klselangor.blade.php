...
<div class="banner">
    <video autoplay muted loop class="banner-video" style="top: 0; left: 0; z-index: -1; width: 100%; height: 100%;">
        <source src="/vid/klselangor.mp4" type="video/mp4">
    ...
    <div class="mx-auto">
        <nav class="text-sm" aria-label="Breadcrumb">
            <ol class="list-none px-8 inline-flex">
                ...
                <li class="flex items-center">
                    <a href="/klselangor" class="text-gray-700 hover:text-gray-900"> &nbsp&nbsp Kuala Lumpur / Selangor</a>
                </li>
            </ol>
        </nav>
    </div>
