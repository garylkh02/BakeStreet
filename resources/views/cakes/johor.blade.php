...
@section('content')
<div class="banner">
    <img src="/img/johor.svg" class="banner-image" alt="Banner Image">
</div>
    ...
    <div class="mx-auto">
        <nav class="text-sm" aria-label="Breadcrumb">
            <ol class="list-none px-8 inline-flex">
                ...
                <li class="flex items-center">
                    <a href="/penang" class="text-gray-700 hover:text-gray-900"> &nbsp&nbsp Johor Bahru</a>
                </li>
            </ol>
        </nav>
    </div>
