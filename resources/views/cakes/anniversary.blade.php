...
@section('content')
<div class="banner">
    <img src="/img/anniversary.svg" class="banner-image" alt="Banner Image">
</div>
<div class="py-4 pb-2">
    <div class="mx-auto">
        <nav class="text-sm" aria-label="Breadcrumb">
            <ol class="list-none px-8 inline-flex">
                ...
                <li class="flex items-center">
                    <a href="/anniversary" class="text-gray-700 hover:text-gray-900"> &nbsp&nbsp Anniversary</a>
                </li>
            </ol>
        </nav>
    </div>
                          ...
                          <div class="rounded-md">
                              ...
                              @if($cake->original_price && $cake->price < $cake->original_price)
                                  <div class="flex">
                                      ...
                                      <h5 class="mt-3"><span style="color: red;">RM {{ $cake->price }}</span></h5>
                                  </div>
                              @else
