    ...
    <div class="max-w-7xl mx-16 sm:px-6 lg:px-8">
        <nav class="text-sm" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
                ...
                <li class="flex items-center">
                    <a href="{{ route('admin.showUser', ['id' => $user->id]) }}" class="text-gray-700 hover:text-gray-900"> &nbsp&nbsp User Details</a>
                </li>
            </ol>
        </nav>
    </div>
...
<div class="container mx-auto p-4">
    <h1 class="text-4xl pt-6 font-semibold text-gray-800 mb-4">User Details</h1>
    ...
    <div class="bg-white border border-gray-200 p-4 mb-7 rounded-lg">
        ...
        <div class="mb-4 text-center">
            <a href="{{ route('admin.user.edit', $user->id) }}" class="px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-md inline-block">
