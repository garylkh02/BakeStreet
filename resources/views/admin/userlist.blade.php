    ...
    <div class="max-w-7xl mx-16 sm:px-6 lg:px-8">
        <nav class="text-sm" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
                ...
                <li class="flex items-center">
                    <a href="/admin/userlist" class="text-gray-700 hover:text-gray-900"> &nbsp&nbsp User List</a>
                </li>
            </ol>
        </nav>
    </div>
...
<div class="w-full px-10 lg:px-8 flex mt-5 mb-4">
    ...
    <div class="searchbar pt-2 pr-1 hidden lg:flex">
        <form action="{{ route('admin.usersearch') }}" method="GET" class="flex">
...
<div class="w-full px-10 pt-3 pb-10">
            ...
            <tbody>
                ...
                <tr class="w-full border-gray-300 border-b">
                    ...
                    <td class="px-6 py-3 whitespace-nowrap text-right text-sm font-medium">
                        <a href="{{ route('admin.showUser', ['id' => $user->id]) }}" class="text-orange-500 hover:text-orange-500">Show</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
